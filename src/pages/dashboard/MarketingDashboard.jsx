    ...
    <Box sx={{ pb: 6, minHeight: '100vh' }}>
      ...
      <Paper elevation={0} sx={{ p: 2.5, px: 3, mb: 3, border: '1px solid', borderColor: 'divider', borderRadius: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2, bgcolor: '#FFFFFF' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Box>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.2 }}>
              ...
              <Chip label="ROLE: MARKETING MANAGER" size="small" sx={{ fontWeight: 900, fontSize: '0.68rem', bgcolor: '#3F51B5', color: '#FFF', height: 24 }} />
              <Chip label="ATTRIBUTION & PROFIT ANALYTICS" size="small" variant="outlined" color="secondary" sx={{ fontWeight: 800, fontSize: '0.68rem', height: 24 }} />
            </Box>
        ...
        <Box sx={{ display: 'flex', gap: 1.5, alignItems: 'center' }}>
          <Button variant="contained" color="secondary" startIcon={<FileDownloadIcon />} onClick={handleExportCSV} sx={{ fontWeight: 800 }}>
